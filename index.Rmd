...
(b_df)
(c(is.tibble(a_df), is.tibble(b_df), is.data.frame(b_df)))
...
For outputting purpose, we may want to re-arrange variables' positions, and we can use `select_at()` or `setcolorder`
